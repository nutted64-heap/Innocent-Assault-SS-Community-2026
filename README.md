...
# 🎮 Innocent Assault SS — Community Edition

**Complete tactical action build — install and play.**
...
Innocent Assault SS is a tactical action game built around objective-driven missions, responsive combat, and varied combat environments. This Community Edition is delivered as a self-contained package that runs as a standalone build with no storefront required. The installer includes all content and is ready to play immediately on Windows 10/11.

Players looking for a complete, offline tactical action experience on PC without storefronts or additional software.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4265410/d32c420247ca662ef0bcde2c3e03592ef2b86bb4/ss_d32c420247ca662ef0bcde2c3e03592ef2b86bb4.1920x1080.jpg?t=1786152354" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4265410/843661f0d4c38e744087a2fa73ae4340235059f8/ss_843661f0d4c38e744087a2fa73ae4340235059f8.1920x1080.jpg?t=1786152354" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4265410/ee4038e010e19569b72ee4092a43296438ae7060/ss_ee4038e010e19569b72ee4092a43296438ae7060.1920x1080.jpg?t=1786152354" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🎯 **Tactical Missions** — Objective-driven scenarios that reward planning and precise execution.
- ⚔️ **Fast Combat** — Responsive action gameplay with a variety of weapons and tools.
- 🗺️ **Varied Environments** — Multiple mission zones with distinct layouts and tactical options.
- 🌐 **LAN / Direct Connection** — LAN and direct P2P connection supported for local multiplayer sessions.
- 🕹️ **Controller Support** — Full gamepad support alongside keyboard and mouse controls.
- ⚙️ **Configurable Settings** — Graphics, audio, and control options adjustable in-game.
- 💾 **Self-Contained Package** — No additional software required — everything needed is included.
- 🔊 **Full Audio Content** — Complete soundtrack and voice audio preserved in the release.
- 🔁 **Replayability** — Mission scoring and alternate approaches encourage repeated playthroughs.

- **Compression:** Lossless
- **Install Time:** ~4 minutes on SSD, ~9 minutes on HDD
- **Recoding:** none
- **Selective Download:** none — full package included in a single installer
...
> 💡 **Saves location:** `%LOCALAPPDATA%\InnocentAssaultSS\Saved`
